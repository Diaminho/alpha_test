package com.example.alpha_test.converters;
...
public class EntityToDTOConverter {
    ...
    private Set<ProductDTO> productSetToDTO(Set<Product> productsSet){
        Set<ProductDTO> productsDTOSet=new HashSet<>();
        if (productsSet!=null) {
            for (Object product : productsSet) {
                productsDTOSet.add(productToDTO((Product) product));
            }
            return productsDTOSet;
        }
        return null;
    }
}
